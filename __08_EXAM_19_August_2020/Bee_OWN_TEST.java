...
public class Bee_OWN_TEST {



    // Този код ще работи, ако искаме бонусът да не изчезва - символът 'О'
    // Ако имаме два последователни символа 'О' обаче, кодът няма да работи!
